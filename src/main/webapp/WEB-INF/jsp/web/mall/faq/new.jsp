					...
					<aside id="sidebar-left" class="col-md-3">
						...
						<div class="panel panel-v3 panel-default bestseller">
							<div class="panel-heading">
								<h4 class="panel-title">新手上路</h4>
							</div>
							<div class="products-block">
								<div class="row products-row tree-menu">
									<ul class="accordion" style="padding: 0 0 0 40px;">
										<li class="accordion-group"><a href="#a1">购买流程</a></li>
										<li class="accordion-group"><a href="#a2">物流政策</a></li>
										<li class="accordion-group"><a href="#a3">订购说明</a></li>
										<li class="accordion-group"><a href="#a4">打款账号</a></li>
										<li class="accordion-group"><a href="#a4">申请样品</a></li>
										<li class="accordion-group"><a href="#a4">购物保障</a></li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-12">
											...
											<p>
												木工板材：<br/>
												木工板材类商品，通常24小时内发货，加工定制产品，通常一周左右发货，以实际配送信息为准；<br/>
												如订单提交成功，有个别商品遇到断货，我们会及时与您联系；<br/>
												数字图文：<br/>
											...
											<p>
												色差告知：<br /> 商品均为实物拍摄 由于拍摄光线不一样以及电脑显示器不同会存在一定色差是难免的
												请以收到实物为准。
											</p>
